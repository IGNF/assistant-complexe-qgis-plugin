...
NOM_FEUILLE = "Assisstant complexe"
...
class Tableur:
    ...
    def initclasseur(self):
        ...
        if not fichier_excel.exists():
            ...
            self.wsfeuille.title = NOM_FEUILLE
            self.wsfeuille["A1"] = "Date"
            self.wsfeuille["B1"] = "N° de transaction"
            self.wsfeuille["C1"] = "CLEABS"
            self.wsfeuille["D1"] = "Avant: " + LIEN_VERS_RTE_NOMMEE
            self.wsfeuille["E1"] = "Apres: " + LIEN_VERS_RTE_NOMMEE
            ...
            self.wsfeuille.column_dimensions["D"].width = 50
            self.wsfeuille.column_dimensions["E"].width = 50

            # Formater les titres (mettre en gras et centrer)
            bold_font = Font(bold=True)
            center_alignment = Alignment(horizontal="center", vertical="center")
            cellule_entete = ["A1", "B1", "C1", "D1", "E1"]
            ...
            self.wsfeuille = self.wbook[NOM_FEUILLE]
